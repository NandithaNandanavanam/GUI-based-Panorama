...
#buttons
Bt1=Button(bottomframe,text="Upload left Image",background="LightBlue", bd=0,width=15,height=1,command=browseimage_left)
Bt1.pack(fill=X,pady=10)

Bt2=Button(bottomframe,text="Upload right Image",background="LightBlue", bd=0,width=15,height=1,command=browseimage_right)
